# encoding: utf-8
# module pyodbc
# from D:\Mine\PatientsData\venv\lib\site-packages\pyodbc.cp39-win_amd64.pyd
# by generator 1.147
"""
...
class Cursor(object):
    ...
    def columns(self, table=None, catalog=None, schema=None,
                column=None):  # real signature unknown; restored from __doc__
        """
    ...
    def foreignKeys(self, table=None, catalog=None, schema=None, foreignTable=None, foreignCatalog=None,
                    foreignSchema=None):  # real signature unknown; restored from __doc__
        """
    ...
    def procedureColumns(self, procedure=None, catalog=None,
                         schema=None):  # real signature unknown; restored from __doc__
        """
    ...
    def rowIdColumns(self, table, catalog=None, schema=None,
                     nullable=True):  # real signature unknown; restored from __doc__
        """
    ...
    def statistics(self, catalog=None, schema=None, unique=False,
                   quick=True):  # real signature unknown; restored from __doc__
        """
    ...
    def tables(self, table=None, catalog=None, schema=None,
               tableType=None):  # real signature unknown; restored from __doc__
        """
...
BinaryNull = None  # (!) real value is '<pyodbc.NullParam object at 0x00000199A9848C00>'

__loader__ = None  # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000199ABAC22E0>'

__spec__ = None  # (!) real value is "ModuleSpec(name='pyodbc', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000199ABAC22E0>, origin='D:\\\\Mine\\\\PatientsData\\\\venv\\\\lib\\\\site-packages\\\\pyodbc.cp39-win_amd64.pyd')"
